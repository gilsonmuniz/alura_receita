...
SECRET_KEY = 'z5r%!oavlba=k3#7o1mdhfo9vqb=50zok&@6$c%b#j)_ro01p1'
...
sys.path.insert(0, os.path.join(PROJECT_ROOT, '../apps')) # especificando o caminho das pastas dos apps